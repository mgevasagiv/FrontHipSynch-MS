...
function [ripples,ripples_stat, exc]=ripples_detection_excluding_IED_MGS(signal,BP,t,th,minDistance,minRippleDuration,maxRippleDuration,noise_ch,IED_ch,IED_onsets, Fs)
